...
package com.taurusx.xsite.modules.gen.utils;
...
import com.taurusx.xsite.common.mapper.JaxbMapper;
import com.taurusx.xsite.common.utils.DateUtils;
import com.taurusx.xsite.common.utils.FileUtils;
import com.taurusx.xsite.common.utils.FreeMarkers;
import com.taurusx.xsite.common.utils.StringUtils;
import com.taurusx.xsite.modules.gen.entity.GenCategory;
import com.taurusx.xsite.modules.gen.entity.GenConfig;
import com.taurusx.xsite.modules.gen.entity.GenScheme;
import com.taurusx.xsite.modules.gen.entity.GenTable;
import com.taurusx.xsite.modules.gen.entity.GenTableColumn;
import com.taurusx.xsite.modules.gen.entity.GenTemplate;
...
//		}
	...
	public static String generateToFile(GenTemplate tpl, Map<String, Object> model, boolean isReplaceFile){
		// 获取生成文件
	    // 增加Windows分隔符设置， add by Taurusx, 20170412 
	    String fileSeparator = File.separator;
	    if (fileSeparator.equals("\\")) {//windows分隔符
		...
		String fileName = Global.getProjectPath() + File.separator 
				+ StringUtils.replaceEach(FreeMarkers.renderString(tpl.getFilePath() + "/", model), 
						new String[]{"//", "/", "."}, new String[]{fileSeparator, fileSeparator, fileSeparator})
