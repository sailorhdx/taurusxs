...
public class GenTableController extends BaseController {
    ...
    public Page<GenTable> pageData(GenTable genTable, HttpServletRequest request, HttpServletResponse response, Model model) {
        User user = UserUtils.getUser();
        if (!user.isAdmin()){
            genTable.setCreateBy(user);
        }
        return genTableService.find(new Page<GenTable>(request, response), genTable); 
    }
	...
	public Map<String,?> delete(GenTable genTable, RedirectAttributes redirectAttributes) {
