...
import com.taurusx.xsite.modules.cms.service.ArticleDataService;
import com.taurusx.xsite.modules.cms.service.ArticleService;
import com.taurusx.xsite.modules.cms.service.CategoryService;
import com.taurusx.xsite.modules.cms.service.FileTplService;
import com.taurusx.xsite.modules.cms.service.SiteService;
import com.taurusx.xsite.modules.cms.utils.CmsUtils;
import com.taurusx.xsite.modules.cms.utils.TplUtils;
...
//		}
	...
	public Page<Article> pageData(Article article, HttpServletRequest request, HttpServletResponse response, Model model) {
	    return articleService.findPage(new Page<Article>(request, response), article, true); 
	}
...
//		}
	...
	public Map<String,?> delete(Article article, String categoryId, @RequestParam(required=false) Boolean isRe, RedirectAttributes redirectAttributes) {
		// 如果没有审核权限，则不允许删除或发布。
