...
import com.taurusx.xsite.common.beanvalidator.BeanValidators;
...
import com.taurusx.xsite.common.utils.excel.ExportExcel;
import com.taurusx.xsite.common.utils.excel.ImportExcel;
...
public class UserController extends BaseController {
	...
	public Page<User> pageData(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	public Map<String,?> delete(User user, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
    ...
    public Map<String, ?> importFile(MultipartFile file, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return redirectAttributes.getFlashAttributes();
		}
