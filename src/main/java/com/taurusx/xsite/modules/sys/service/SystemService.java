...
import com.taurusx.xsite.common.security.Digests;
import com.taurusx.xsite.common.security.shiro.session.SessionDAO;
import com.taurusx.xsite.common.service.BaseService;
import com.taurusx.xsite.common.service.ServiceException;
import com.taurusx.xsite.common.utils.CacheUtils;
import com.taurusx.xsite.common.utils.Encodes;
import com.taurusx.xsite.common.utils.StringUtils;
import com.taurusx.xsite.common.web.Servlets;
import com.taurusx.xsite.modules.sys.dao.MenuDao;
import com.taurusx.xsite.modules.sys.dao.RoleDao;
import com.taurusx.xsite.modules.sys.dao.UserDao;
...
import com.taurusx.xsite.modules.sys.security.SystemAuthorizingRealm;
import com.taurusx.xsite.modules.sys.utils.LogUtils;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	@Transactional(readOnly = false)
    public void saveFavorite(Menu menu) {
        menuDao.insertFavorite(menu);
        // 清除用户菜单缓存
        UserUtils.removeCache(UserUtils.CACHE_MENU_LIST);
    ...
    @Transactional(readOnly = false)
    public void deleteFavorite(Menu menu) {
        menuDao.deleteFavorite(menu);
        // 清除用户菜单缓存
        UserUtils.removeCache(UserUtils.CACHE_MENU_LIST);
