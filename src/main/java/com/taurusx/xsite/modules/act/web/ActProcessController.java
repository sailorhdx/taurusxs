...
package com.taurusx.xsite.modules.act.web;
...
import com.taurusx.xsite.modules.act.service.ActProcessService;
...
public class ActProcessController extends BaseController {
	...
	public Map<String,?> delete(String deploymentId, RedirectAttributes redirectAttributes) {
		actProcessService.deleteDeployment(deploymentId);
		addMessage(redirectAttributes, "删除流程成功，流程ID=" + deploymentId);
		//return "redirect:" + adminPath + "/act/process";
	...
	public Map<String,?> deleteProcIns(String procInsId, String reason, RedirectAttributes redirectAttributes) {
		if (StringUtils.isBlank(reason)){
			addMessage(redirectAttributes, "刪除流程失败，请填写删除原因!");
		}else{
