...
import com.taurusx.xsite.modules.act.service.ActTaskService;
...
//		return "modules/act/actTaskForm";
	 ...
	 * 		vars.keys=flag,pass
	 * 		vars.values=1,true
	 * 		vars.types=S,B  @see com.taurusx.xsite.modules.act.utils.PropertyType
	 */
	...
	public Map<String,?> deleteTask(String taskId, String reason, RedirectAttributes redirectAttributes) {
