...
import com.taurusx.xsite.modules.test.service.TestDataService;
...
public class TestDataController extends BaseController {
	...
	public Page<TestData> pageData(TestData testData, HttpServletRequest request, HttpServletResponse response, Model model) {
		return testDataService.findPage(new Page<TestData>(request, response), testData); 
	}
	...
	public Map<String,?> delete(TestData testData, RedirectAttributes redirectAttributes) {
