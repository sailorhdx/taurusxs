...
import com.taurusx.xsite.modules.test.service.TestTreeService;
...
public class TestTreeController extends BaseController {
	...
	public List<TestTree> listData(TestTree testTree, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	public Map<String,?> delete(TestTree testTree, RedirectAttributes redirectAttributes) {
