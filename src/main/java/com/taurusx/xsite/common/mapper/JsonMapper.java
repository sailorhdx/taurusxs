...
package com.taurusx.xsite.common.mapper;
...
public class JsonMapper extends ObjectMapper {
    ...
    public void setEnumUseToString(boolean value) {
        this.configure(SerializationFeature.WRITE_ENUMS_USING_TO_STRING, value);
        this.configure(DeserializationFeature.READ_ENUMS_USING_TO_STRING,
                value);
    }

    public JsonNode parseNode(String json) {
        try {
            return this.readValue(json, JsonNode.class);
        } catch (IOException e) {
            return null;
        }
    }
