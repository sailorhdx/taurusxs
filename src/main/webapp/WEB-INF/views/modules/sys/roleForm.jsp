   	...
   	<div class="portlet light">
        <div class="portlet-title">
            <div class="caption">
				...
				<a href="${ctxAdmin}/sys/role/form?id=${role.id}" class="ajaxify">
        ...
        <div class="portlet-body">
			...
			<form:form id="inputForm" modelAttribute="role" action="${ctxAdmin}/sys/role/save" method="post" class="form-horizontal">
				...
				<div class="form-group">
					<label class="control-label col-md-4 required">归属机构</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="control-label col-md-4 required">英文名称</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="control-label col-md-4 required">角色类型</label>
					<div class="col-md-6"><%--
						...
						<form:select path="roleType" class="mt-multiselect btn btn-default required" data-label="left" data-select-all="false" data-width="100%" data-filter="true" data-action-onchange="true">
				...
				<div class="form-group">
					<label class="control-label col-md-4">是否系统数据</label>
					<div class="col-md-6">
						<form:select path="sysData" class="mt-multiselect btn btn-default" data-label="left" data-select-all="false" data-width="100%" data-filter="true" data-action-onchange="true">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<form:select path="useable" class="mt-multiselect btn btn-default" multiple="single" data-label="left" data-select-all="false" data-width="100%" data-filter="true" data-action-onchange="true">
							<form:options items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>	
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<form:select path="dataScope" class="mt-multiselect btn btn-default" multiple="single" data-label="left" data-select-all="false" data-width="100%" data-filter="true" data-action-onchange="true">
				...
				<div class="form-group">
					<label class="control-label col-md-4">角色授权</label>
					<div class="col-md-3">
				...
				<div class="form-group">
	               <div class="col-md-offset-4 col-md-6">				
						<input id="btnCancel" class="btn default" type="button" value="返回" onclick="locationHref('${ctxAdmin}/sys/role');"/>
