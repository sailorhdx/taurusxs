...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$.get("${ctxAdmin}${url}${fn:indexOf(url,'?')==-1?'?':'&'}&extId=${extId}&isAll=${isAll}&module=${module}&t="
...
<body>
	<div id="search" class="form-search" style="padding:5px 5px;display:block">
		<div class="input-group">
			<input type="text" id="key" name="key" maxlength="50" class="form-control" placeholder="搜索关键字">
			<span class="input-group-btn">
               <button class="btn" type="button" onclick="searchNode()">
                   <i class="fa fa-search" /></i>搜索</button>
           </span>
		</div>
	<div id="tree" class="ztree" style="padding:5px 5px;"></div>
</body>