...
<%@ attribute name="value" type="java.lang.String" required="true" description="输入框值"%>
    ...
    <i id="${id}Icon" class="fa fa-${not empty value?value:' hide'}"></i>&nbsp;                     
	<label id="${id}IconLabel">${not empty value?value:'无'}</label>&nbsp;
    <button id="${id}ButtonIconModal"  class="btn blue" type="button" data-toggle="modal" data-target="#iconModal">选择</button>&nbsp;&nbsp;
	<!-- <button id="${id}Button" href="javascript:" class="btn blue" type="button">选择JBOX</button> -->
	
<script type="text/javascript">
	$("#${id}Button").click(function(){
		top.$.jBox.open("iframe:${ctxAdmin}/tag/iconselect?value="+$("#${id}").val(), "选择图标", 700, 500, {
...
<!-- 模态框（Modal） -->
<style type="text/css">
.blue{background-color:#0088CC;color:#ffffff;}
</style>
    
<div class="modal fade draggable-modal" id="iconModal" tabindex="-1" role="basic" aria-hidden="true">
	<input type="hidden" id="icon-in" value="${value}" />
	<!-- BEGIN MODAL DIALOG -->
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
                ...
                <div class="portlet">
                    <div class="portlet-title  hidden">
                        <div class="caption"><i class="fa fa-gift"></i>图标列表</div>
                    </div>
                    <div class="portlet-body">
                   		<!-- BEGIN ICONS scroller-->
                        <div id="icons" class="scroller fontawesome-demo " style="height:300px;white-space:nowrap;" data-rail-visible="1" data-rail-color="yellow" data-handle-color="#a1b2bd">
                                            <section id="web-application">
                                                <legend>Web Application Icons</legend>
                                                <div class="row fontawesome-icon-list">
                                                    <div class="fa-item col-md-4 blue">
                                                        <i class="fa fa-adjust"></i> adjust</div>
                                                    <div class="fa-item col-md-4">
                                            ...
                                            <section id="transportation">
                                                <legend>Transportation Icons</legend>
                                                <div class="row fontawesome-icon-list">
                                                    <div class="fa-item col-md-4">
                                            ...
                                            <section id="form-control">
                                                <legend>Form Control Icons</legend>
                                                <div class="row fontawesome-icon-list">
                                                    <div class="fa-item col-md-4">
                                                        <i class="fa fa-check-square"></i> check-square</div>
                                                    <div class="fa-item col-md-4">
                                            ...
                                            <section id="text-editor">
                                                <legend>Text Editor Icons</legend>
                                                <div class="row fontawesome-icon-list">
                                                    <div class="fa-item col-md-4">
                                            ...
                                            <section id="directional">
                                                <legend>Directional Icons</legend>
                                                <div class="row fontawesome-icon-list">
                                                    <div class="fa-item col-md-4">
                                            ...
                                            <section id="video-player">
                                                <legend>Video Player Icons</legend>
                                                <div class="row fontawesome-icon-list">
                                                    <div class="fa-item col-md-4">
                                                        <i class="fa fa-arrows-alt"></i> arrows-alt</div>
                                                    <div class="fa-item col-md-4">
			...
			<div class="modal-footer">
				...
				<button id="btnClearIcon" type="button" class="btn btn-warning" data-dismiss="modal">清除</button>
				<button id="btnSubmitIcon" type="button" class="btn btn-primary" data-dismiss="modal">提交</button>
			</div>
			<!-- END MODAL FOOTER -->
		</div>
		<!-- END MODAL CONTENT -->
...
<script type="text/javascript">
	...
	$("#icons .fa-item").click(function(){
		$("#icons .fa-item").removeClass("blue");
		$(this).addClass("blue");
		var _icon = $(this).text().replace("(alias)", "").trim();
		console.log("====" + _icon);
		$("#icon-in").val(_icon);
	});
	...
	// “选择”按钮点击事件
	$('#btnSubmitIcon').click(function(){
		var icon =  $("#icon-in").val();
   		$("#${id}Icon").attr("class", "fa fa-"+icon);
		$("#${id}IconLabel").text(icon);
		$("#${id}").val(icon);
	});	
	...
	$(function () {
		...
		$('#iconModal').on('show.bs.modal', function () {
			// 执行一些动作...
			//alert("show.bs.modal 1");
			// 清除图标选中状态
			$("#icons div").removeClass("blue");
		});
		
		// 当模态框对用户可见时触发（将等待 CSS 过渡效果完成）。
		$('#iconModal').on('shown.bs.modal', function () {
			console.log("shown.bs.modal 2");
			// 执行一些动作...
			var icon = $("#${id}").val();
		...
		$('#iconModal').on('hide.bs.modal', function () {
			// 执行一些动作...
			//alert("hide.bs.modal 3");
		});
		
		// 当模态框完全对用户隐藏时触发。
	   	$('#iconModal').on('hidden.bs.modal', function () {
  			// 执行一些动作...
	   		//alert("hidden.bs.modal 4");
		});
