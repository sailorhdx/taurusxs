...
<script src="${ctxStatic}/metronic/assets/global/plugins/ckeditor/ckeditor.js" type="text/javascript"></script>
...
<script type="text/javascript">
	...
	${replace}Ckeditor.config.ckfinderPath="${ctxStatic}/metronic/assets/global/plugins/ckfinder";
