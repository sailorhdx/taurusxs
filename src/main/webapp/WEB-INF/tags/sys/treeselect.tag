...
<%@ attribute name="inputWidth" type="java.lang.String" required="false" description="控件尺寸，input-large,input-medium,input-small"%>
<input id="${id}Id" name="${name}" type="hidden" value="${value}"/>
<div class="input-group ${inputWidth }">
	<input id="${id}Name" name="${labelName}" ${allowInput?'':'readonly="readonly"'} type="text" value="${labelValue}" data-msg-required="${dataMsgRequired}"
		class="treeselect form-control ${inputWidth } ${cssClass}" />
    <span class="input-group-btn">
        <button id="${id}Button" class="btn blue ${disabled} ${hideBtn ? 'hide' : ''}" type="button">选择</button>
    </span>		
</div>
