...
$.extend($.fn, {
    initJerichoTab: function(setting) {
        ...
        $.fn.jerichoTab.resize = function() {
            ...
            $('#jerichotab_contentholder').attr("style",""); // add by wanghp
        };
    ...
    loadData: function(flag) {
        return this.each(function() {
        	...
        	$('.jericho_tab .tab_selected').css('background-color', $('.page-wrapper').css('background-color')); // edit by wanghp
    ...
    removeLoader: function() {
        switch ($.fn.jerichoTab.loader) {
            case 'usebg':
                ...
                $('#jerichotab_contentholder').removeClass('loading').attr("style",""); // edit by wanghp
                break;
            case 'righttag':
