...
(function(a) {
	a.jBox = function(b, c) {
		...
		if (!c.isTip && !c.isMessager && !c.showScrolling) {
			a((navigator.appName=='Microsoft Internet Explorer') ? 'html' : 'body').attr('style',
		...
		j.push('<div class="jbox-help-title jbox-title-panel" style="height:35px;padding:5px 0 5px 0;display:none;"></div>');
		...
		if (c.border > 0x0) {
			j.push('<tr>');
			j.push('<td class="jbox-border" style="margin:0px;padding:0px;border:none;border-radius:'
							+ c.border
							+ 'px 0 0 0;width:'
							+ c.border
							+ 'px;height:' + c.border + 'px;"></td>');
			j.push('<td class="jbox-border" style="margin:0px;padding:0px;border:none;height:'
							+ c.border + 'px;overflow: hidden;"></td>');
			j.push('<td class="jbox-border" style="margin:0px;padding:0px;border:none;border-radius:0 '
							+ c.border
							+ 'px 0 0;width:'
							+ c.border
							+ 'px;height:' + c.border + 'px;"></td>');
		...
		j.push('<a class="jbox-close" title="'
		...
		if (g) {
			...
			j.push('<div class="jbox-title'
							...
							+ i
							+ '; line-height:'
							+ ((navigator.appName=='Microsoft Internet Explorer') ? 0x19 : 0x18) 
							+ 'px; padding-left:'
							+ (c.showIcon ? 0x12 : 0x5)
		...
		if (c.border > 0x0) {
			j.push('<tr>');
			j.push('<td class="jbox-border" style="margin:0px;padding:0px;border:none;border-radius:0 0 0 '
							+ c.border
							+ 'px; width:'
							+ c.border
							+ 'px; height:' + c.border + 'px;"></td>');
			j.push('<td class="jbox-border" style="margin:0px;padding:0px;border:none;height:'
							+ c.border + 'px;overflow: hidden;"></td>');
			j.push('<td class="jbox-border" style="margin:0px;padding:0px;border:none;border-radius:0 0 '
							+ c.border
							+ 'px 0; width:'
							+ c.border
							+ 'px; height:' + c.border + 'px;"></td>');
		...
		var u =  (navigator.appName=='Microsoft Internet Explorer') ? 'line-height:19px;padding:0px 6px 0px 6px;'
						...
						function(N, O) {
							...
							if (!f.isObject && h) {
								...
								if (typeof c.height == 'number') {
									...
									R = ['<div id="jbox-content-loading" class="jbox-content-loading" style="min-height:70px;height:'
									+ T + '; text-align:center;">',
									'<div class="jbox-content-loading-image" style="display:block; margin:auto; width:220px; height:19px; padding-top: '
									+ S + ';"></div>', '</div>' ]
										.join('')
							};
							r.push('<div id="jbox-state-'
								+ N
								+ '" class="jbox-state" style="display:none;">');
							r.push('<div style="min-width:50px;width:'
							+ (typeof c.width == 'number' ? c.width
											...
											+ O.content + '</div></div>');
							r.push('<div class="jbox-button-panel" style="height:35px;padding:5px 0 5px 0;text-align: right;'
											+ (P ? '' : 'display:none;') + '">');
							if (!c.isTip) {
	...
	a.jBox.prompt = function(b, c, d, e) {
		...
		var g = e.icon == 'none' ? 'height:auto;'
				: 'min-height:30px;'
						+ (('undefined' == typeof(document.body.style.maxHeight)) ? 'height:auto !important;height:100%;_height:30px;': 'height:auto;');
		var h = [];
		h.push('html:');
	...
	a.jBox.messager = function(b, c, d, e) {
		...
		var h = e.icon == 'none' ? 'height:auto;'
				: 'min-height:30px;'
						+ (('undefined' == typeof(document.body.style.maxHeight)) ? 'height:auto !important;height:100%;_height:30px;'
								: 'height:auto;');
		var i = [];
		i.push('html:');
